...
struct	pentry	{
	...
	int	pwaitret;
	int systemCallTab[100];
	/*
	 * Each entry will be filled till '#ofSystemCalls' with 1-6 indicating each system call
	 * getpid,gettime,kill,signal,sleep,wait
	*/
	int systemCallCount;	/*Maintains Total Number of System call called*/
};
